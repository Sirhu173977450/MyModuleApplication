package com.example.nicedialog.nicedialog;
...
import com.example.nicedialog.R;
...
public abstract class BaseNiceDialog extends DialogFragment {
    ...
    private void initParams() {
        ...
        if (window != null) {
            ...
            //设置dialog宽度
            if (width == 0) {
                lp.width = ScreenTools.instance(getContext()).getScreenWidth() - 2 * ScreenTools.instance(getContext()).dip2px(margin);
            } else if (width == -1) {
                lp.width = WindowManager.LayoutParams.WRAP_CONTENT;
            } else {
                lp.width = ScreenTools.instance(getContext()).dip2px(width);
            }
            ...
            if (height == 0) {
                ...
                lp.height = ScreenTools.instance(getContext()).dip2px(height);
            }
