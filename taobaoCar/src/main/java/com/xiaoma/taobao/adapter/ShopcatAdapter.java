...
public class ShopcatAdapter extends BaseExpandableListAdapter  {
    ...
    public View getGroupView(final int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        groupViewHolder.mNameStore.setText(group.getName());
        groupViewHolder.mCheckBoxStore.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        groupViewHolder.mCheckBoxStore.setChecked(group.isChoosed());
        ...
        if (group.isActionBarEditor()) {
            ...
            groupViewHolder.mEditStore.setVisibility(View.GONE);
            flag = false;
        } else {
            flag = true;
            groupViewHolder.mEditStore.setVisibility(View.VISIBLE);
        }
         ...
         */
        if (group.isEditor()) {
            groupViewHolder.mEditStore.setText("完成");
        } else {
            groupViewHolder.mEditStore.setText("编辑");
        }

        groupViewHolder.mEditStore.setOnClickListener(new GroupViewClick(group, groupPosition, groupViewHolder.mEditStore));
        return convertView;
    }
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (flag) {
            if (groups.get(groupPosition).isEditor()) {
                childViewHolder.mmDataGoodsEdit.setVisibility(View.VISIBLE);
                childViewHolder.mGoodsDel.setVisibility(View.VISIBLE);
                childViewHolder.mDataGoods.setVisibility(View.GONE);
            } else {
                childViewHolder.mGoodsDel.setVisibility(View.VISIBLE);
                childViewHolder.mDataGoods.setVisibility(View.VISIBLE);
                childViewHolder.mmDataGoodsEdit.setVisibility(View.GONE);
            }
        } else {

            if (groups.get(groupPosition).isActionBarEditor()) {
                childViewHolder.mGoodsDel.setVisibility(View.GONE);
                childViewHolder.mmDataGoodsEdit.setVisibility(View.VISIBLE);
                childViewHolder.mDataGoods.setVisibility(View.GONE);
            } else {
                childViewHolder.mGoodsDel.setVisibility(View.VISIBLE);
        ...
        if (child != null) {
            childViewHolder.mNameGoods.setText(child.getDesc());
            childViewHolder.mPriceGoods.setText("￥" + child.getPrice() + "");
            childViewHolder.mNumGoods.setText(String.valueOf(child.getCount()));
            childViewHolder.mImageGoods.setImageResource(R.drawable.cmaz);
            childViewHolder.mSizeGoods.setText("门票:" + child.getColor() + ",类型:" + child.getSize());
            //设置打折前的原价
            ...
            //避免无限次的append
            if (childViewHolder.mPrimePriceGoods.length() > 0) {
                childViewHolder.mPrimePriceGoods.setText("");
            }
            childViewHolder.mPrimePriceGoods.setText(spannableString);
            childViewHolder.mBuyNumGoods.setText("x" + child.getCount() + "");
            childViewHolder.mCheckBoxSingle.setChecked(child.isChoosed());
            childViewHolder.mCheckBoxSingle.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    child.setChoosed(((CheckBox) v).isChecked());
                    childViewHolder.mCheckBoxSingle.setChecked(((CheckBox) v).isChecked());
                    checkInterface.checkChild(groupPosition, childPosition, ((CheckBox) v).isChecked());
                }
            });
            childViewHolder.mmNameGoodsIncrease.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    modifyCountInterface.doIncrease(groupPosition, childPosition, childViewHolder.mNumGoods, childViewHolder.mCheckBoxSingle.isChecked());
                }
            });
            childViewHolder.mmNameGoodsReduce.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    modifyCountInterface.doDecrease(groupPosition, childPosition, childViewHolder.mNumGoods, childViewHolder.mCheckBoxSingle.isChecked());
                }
            });
            childViewHolder.mNumGoods.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    showDialog(groupPosition, childPosition, childViewHolder.mNumGoods, childViewHolder.mCheckBoxSingle.isChecked(), child);
                }
            });
            childViewHolder.mGoodsDel.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    static class GroupViewHolder {
        ...
        private TextView mNameStore;
        private Button mEditStore;

        public GroupViewHolder(View itemView) {
            mCheckBoxStore = (CheckBox) itemView.findViewById(R.id.store_checkBox);
            mNameStore = (TextView) itemView.findViewById(R.id.store_name);
            mEditStore = (Button) itemView.findViewById(R.id.store_edit);
        }
    }
    ...
    static class ChildViewHolder {
        ...
        private TextView mNameGoods;
        private TextView mSizeGoods;
        private TextView mPriceGoods;
        private TextView mPrimePriceGoods;
        private TextView mBuyNumGoods;
        private RelativeLayout mDataGoods;
        private TextView mmNameGoodsReduce;
        private TextView mNumGoods;
        private TextView mmNameGoodsIncrease;
        private TextView mGoodsSize;
        private TextView mGoodsDel;
        private LinearLayout mmDataGoodsEdit;

        public ChildViewHolder(View itemView) {
            mCheckBoxSingle = (CheckBox) itemView.findViewById(R.id.single_checkBox);
            mImageGoods = (ImageView) itemView.findViewById(R.id.goods_image);
            mNameGoods = (TextView) itemView.findViewById(R.id.goods_name);
            mSizeGoods = (TextView) itemView.findViewById(R.id.goods_size);
            mPriceGoods = (TextView) itemView.findViewById(R.id.goods_price);
            mPrimePriceGoods = (TextView) itemView.findViewById(R.id.goods_prime_price);
            mBuyNumGoods = (TextView) itemView.findViewById(R.id.goods_buyNum);
            mDataGoods = (RelativeLayout) itemView.findViewById(R.id.goods_data);
            mmNameGoodsReduce = (TextView) itemView.findViewById(R.id.reduce_goodsNum);
            mNumGoods = (TextView) itemView.findViewById(R.id.goods_Num);
            mmNameGoodsIncrease = (TextView) itemView.findViewById(R.id.increase_goods_Num);
            mGoodsSize = (TextView) itemView.findViewById(R.id.goodsSize);
            mGoodsDel = (TextView) itemView.findViewById(R.id.del_goods);
            mmDataGoodsEdit = (LinearLayout) itemView.findViewById(R.id.edit_goods_data);
        }
    }
}
