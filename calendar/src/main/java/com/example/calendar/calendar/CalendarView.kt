...
import com.example.calendar.calendar.model.*
import com.example.calendar.calendar.ui.*
import com.example.calendar.calendar.utils.Size
import com.example.calendar.calendar.utils.job
...
//        val ta: TypedArray = context.obtainStyledAttributes(attributeSet, R.styleable.YLCircleImageView)
//        //  半径
//        //  半径
//        dayViewResource = ta.getDimension(R.styleable.CalendarViewImage_cv_dayViewResource, dayViewResource)

        context.withStyledAttributes(attributeSet, R.styleable.CalendarViewImage, defStyleAttr, defStyleRes) {
            dayViewResource = getResourceId(R.styleable.CalendarViewImage_cv_dayViewResource, dayViewResource)
            monthHeaderResource = getResourceId(R.styleable.CalendarViewImage_cv_monthHeaderResource, monthHeaderResource)
            monthFooterResource = getResourceId(R.styleable.CalendarViewImage_cv_monthFooterResource, monthFooterResource)
            orientation = getInt(R.styleable.CalendarViewImage_cv_orientation, orientation)
            scrollMode = ScrollMode.values()[getInt(R.styleable.CalendarViewImage_cv_scrollMode, scrollMode.ordinal)]
            outDateStyle = OutDateStyle.values()[getInt(R.styleable.CalendarViewImage_cv_outDateStyle, outDateStyle.ordinal)]
            inDateStyle = InDateStyle.values()[getInt(R.styleable.CalendarViewImage_cv_inDateStyle, inDateStyle.ordinal)]
            maxRowCount = getInt(R.styleable.CalendarViewImage_cv_maxRowCount, maxRowCount)
            monthViewClass = getString(R.styleable.CalendarViewImage_cv_monthViewClass)
            hasBoundaries = getBoolean(R.styleable.CalendarViewImage_cv_hasBoundaries, hasBoundaries)
            wrappedPageHeightAnimationDuration = getInt(R.styleable.CalendarViewImage_cv_wrappedPageHeightAnimationDuration,
