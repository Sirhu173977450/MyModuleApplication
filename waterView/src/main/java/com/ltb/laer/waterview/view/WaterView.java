...
//            tvWater.setText(String.valueOf(water.getNumber()) + "g");
            ...
            Log.e("TAG____content: ", tvWater.getText().toString());
            setChildViewLocation(view,tvWater);
//            setChildViewLocation(view);
    ...
    private void setChildViewLocation(View view) {
        ...
        Log.e("TAG____X", (float) (maxX * getX_YRandom(mXCurrentCanShoseRandoms, mXRandoms)) + "");
        Log.e("TAG____Y", (float) (maxY * getX_YRandom(mYCurrentCanShoseRandoms, mYRandoms)) + "");
        Log.e("TAG____Y", "________");
        view.setTag(R.string.original_y, view.getY());
    }
     ...
     * @param view
     */
    private void setChildViewLocation(View view, TextView tvWater) {
        if ("0".equals(tvWater.getText().toString())) {
            view.setX((float) 25.0);
            view.setY((float) 484.75);
        } else if ("1".equals(tvWater.getText().toString())) {
            view.setX((float) 126.80);
            view.setY((float)  170.75);
        } else if ("2".equals(tvWater.getText().toString())) {
            view.setX((float) 380.8);
            view.setY((float) 195.75);
        } else if ("3".equals(tvWater.getText().toString())) {
            view.setX((float) 620.0);
            view.setY((float) 150.75);
        } else if ("4".equals(tvWater.getText().toString())) {
            view.setX((float) 870.0);
            view.setY((float) 230.75);
        }  else{
            view.setX((float) 900.6);
            view.setY((float) 500.75);
        }
//        view.setX((float) (maxX * getX_YRandom(mXCurrentCanShoseRandoms, mXRandoms)));
//        view.setY((float) (maxY * getX_YRandom(mYCurrentCanShoseRandoms, mYRandoms)));
//        Log.e("TAG____X", (float) (maxX * getX_YRandom(mXCurrentCanShoseRandoms, mXRandoms)) + "");
